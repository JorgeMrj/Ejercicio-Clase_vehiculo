...
interface VehiculosRepository : CrudRepository<Vehiculo, Int> {
    fun filterBy(predicate: (Vehiculo) -> Boolean = { true }): List<Vehiculo>
    ...
    fun sortedBy(mode: ModoOrdenamiento = ModoOrdenamiento.ASC, condition: (Vehiculo) -> Int): List<Vehiculo>
}
